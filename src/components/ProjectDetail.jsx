              ...
              <AnimatePresence mode="wait">
                {selectedGalleryImage && (
                  ...
                  >
                    <img
                      src={
                        sanitizeUrl(selectedGalleryImage.image) ||
                        FALLBACK_IMAGE
                      }
                      ...
                      onError={() =>
                        console.warn(
                          `Failed to load gallery image: ${selectedGalleryImage.image}`
                        )
                      }
                      loading="lazy"
                      srcSet={`
                  ...
                  project.details.gallery.map((item, index) => (
                    <button
                      ...
                      className={`
                        ...
                        ${
                          selectedGalleryImage?.image === item.image
                    ...
                    >
                      <img
                        ...
                        onError={() =>
                          console.warn(
                            `Failed to load thumbnail: ${item.image}`
                          )
                        }
                        loading="lazy"
                        srcSet={`
